...
class ChaosTestEnv:
    def __init__(self, test_env='NODE66'):
        self.__env = test_env
        self.__chaos = Chaos.Init(self.__env)
        self.__log = Log.MyLog()


    def kill_main_server(self):
        linkoopdb = Linkoopdb.Init(self.__env)
...
if __name__=="__main__":
    remoteMachine = RemoteMachine.Init('192.168.1.64','root', '123456')
    remoteMachine.kubectl.pod.get_server_pods()

    chaosTestEnv = ChaosTestEnv('NODE66')
